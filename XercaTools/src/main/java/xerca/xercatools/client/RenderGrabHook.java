...
public class RenderGrabHook extends EntityRenderer<EntityGrabHook, GrabHookRenderState> {
    private static final Identifier TEXTURE = Mod.id("textures/particle/hook.png");
    private static final Identifier CHAIN_TEXTURE = Identifier.fromNamespaceAndPath("minecraft", "textures/block/iron_chain.png");
