...
public class HammerAttackPacketHandler {
    ...
    private static void processMessage(HammerAttackPacket msg, ServerPlayerEntity pl) {
        ...
        if (item instanceof ItemWarhammer){
            ...
            pl.world.playSound(null, target.posX, target.posY + 0.5d, target.posZ, SoundEvents.HAMMER, SoundCategory.PLAYERS, 1.0f, pl.world.rand.nextFloat() * 0.1F + 0.4F + pitch);
