    ...
    public static class RegistrationHandler {
        ...
        public static void registerBlocks(final RegistryEvent.Register<Block> event) {
            event.getRegistry().registerAll(
                    ...
                    new BlockTerracottaTile().setRegistryName("black_terratile"),
                    new BlockTerracottaTile().setRegistryName("blue_terratile"),
                    new BlockTerracottaTile().setRegistryName("brown_terratile"),
                    new BlockTerracottaTile().setRegistryName("cyan_terratile"),
                    new BlockTerracottaTile().setRegistryName("gray_terratile"),
                    new BlockTerracottaTile().setRegistryName("green_terratile"),
                    new BlockTerracottaTile().setRegistryName("light_blue_terratile"),
                    new BlockTerracottaTile().setRegistryName("light_gray_terratile"),
                    new BlockTerracottaTile().setRegistryName("lime_terratile"),
                    new BlockTerracottaTile().setRegistryName("magenta_terratile"),
                    new BlockTerracottaTile().setRegistryName("orange_terratile"),
                    new BlockTerracottaTile().setRegistryName("pink_terratile"),
                    new BlockTerracottaTile().setRegistryName("purple_terratile"),
                    new BlockTerracottaTile().setRegistryName("red_terratile"),
                    new BlockTerracottaTile().setRegistryName("white_terratile"),
                    new BlockTerracottaTile().setRegistryName("yellow_terratile"),
                    new BlockTerracottaTile().setRegistryName("terratile"),

                    new BlockTerracottaTileSlab().setRegistryName("black_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("blue_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("brown_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("cyan_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("gray_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("green_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("light_blue_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("light_gray_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("lime_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("magenta_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("orange_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("pink_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("purple_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("red_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("white_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("yellow_terratile_slab"),
                    new BlockTerracottaTileSlab().setRegistryName("terratile_slab"),

                    new BlockTerracottaTileStairs(() -> BLACK_TERRATILE.getDefaultState()).setRegistryName("black_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> BLUE_TERRATILE.getDefaultState()).setRegistryName("blue_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> BROWN_TERRATILE.getDefaultState()).setRegistryName("brown_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> CYAN_TERRATILE.getDefaultState()).setRegistryName("cyan_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> GRAY_TERRATILE.getDefaultState()).setRegistryName("gray_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> GREEN_TERRATILE.getDefaultState()).setRegistryName("green_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> LIGHT_BLUE_TERRATILE.getDefaultState()).setRegistryName("light_blue_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> LIGHT_GRAY_TERRATILE.getDefaultState()).setRegistryName("light_gray_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> LIME_TERRATILE.getDefaultState()).setRegistryName("lime_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> MAGENTA_TERRATILE.getDefaultState()).setRegistryName("magenta_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> ORANGE_TERRATILE.getDefaultState()).setRegistryName("orange_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> PINK_TERRATILE.getDefaultState()).setRegistryName("pink_terratile_stairs"),
                    new BlockTerracottaTileStairs(() -> PURPLE_TERRATILE.getDefaultState()).setRegistryName("purple_terratile_stairs"),
