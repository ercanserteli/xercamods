...
public class ItemScythe extends ToolItem {
    ...
    private void spawnHead(String playerName, World world, double x, double y, double z){
        spawnHead(playerName, world, x, y, z, null);
    }

    private void spawnHead(String playerName, World world, double x, double y, double z, @Nullable String nameTransKey){
    ...
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        if(target.getHealth() <= 0 && EnchantmentHelper.getEnchantmentLevel(ENCHANTMENT_GUILLOTINE, stack) > 0){
