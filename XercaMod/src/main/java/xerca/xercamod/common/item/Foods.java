...
public class Foods {
    ...
    public static Food SAKE = makeFood(3, 0.6f, false).setAlwaysEdible().effect(new EffectInstance(Effects.NAUSEA, 340, 1), 0.8f).build();
    ...
    public static Food WHEAT_JUICE = makeFood(3, 0.6f, false).setAlwaysEdible().effect(new EffectInstance(Effects.NAUSEA, 220, 0), 0.3f).build();
