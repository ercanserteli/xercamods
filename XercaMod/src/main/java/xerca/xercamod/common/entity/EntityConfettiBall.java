...
public class EntityConfettiBall extends ProjectileItemEntity {
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            this.world.playSound(null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.CRACK, SoundCategory.PLAYERS, 2.0f, this.rand.nextFloat() * 0.4F + 0.8F);
            this.remove();
        }
    }
    ...
    public void tick() {
        ...
        if(this.ticksExisted % 4 == 0){
            if(!this.world.isRemote){
                ...
                spawnConfetti(this.getPosX(), this.getPosY(), this.getPosZ());
            }
        }
    }
