...
public class EaselModel extends EntityModel<EntityEasel.RenderState> {
    ...
    @Override
    public void setupAnim(EntityEasel.RenderState entityRenderState) {
        if(entityRenderState.getItem().getItem() instanceof ItemCanvas itemCanvas){
