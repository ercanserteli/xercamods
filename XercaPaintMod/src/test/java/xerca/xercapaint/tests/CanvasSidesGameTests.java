...
public class CanvasSidesGameTests {
    ...
    private static final RecipeCanvasCloning CLONING_RECIPE = new RecipeCanvasCloning(new ResourceLocation(xerca.xercapaint.Mod.MOD_ID, "test_canvas_cloning"), CraftingBookCategory.MISC);
    ...
    public static void canvasUpdatePacketRoundTripsSides(GameTestHelper helper) {
        ...
        buf.writeBytes(original.encode());
