...
public class RecipeFillPaletteGameTests {
    ...
    private static final RecipeFillPalette RECIPE = new RecipeFillPalette(
            new ResourceLocation(MODID, "test_palette_filling"), CraftingBookCategory.MISC
    );
    ...
    private static TestCraftingInput createGrid(int width, int height, List<ItemStack> items) {
        return TestCraftingInput.of(width, height, items);
    }
    ...
    private static ItemStack createPaletteWithBasicColors(DyeColor... colors) {
        ...
        palette.getOrCreateTag().putByteArray(ItemPalette.TAG_BASIC_COLORS, basic);
        return palette;
    }
    ...
    public static void fillPaletteAddsNewBasicColorsAndPreservesCustomTag(GameTestHelper helper) {
        ...
        palette.getOrCreateTag().merge(customTag);
        ...
        TestCraftingInput grid = createGrid(3, 3, items);
        ...
        byte[] basic = result.getOrCreateTag().getByteArray(ItemPalette.TAG_BASIC_COLORS);
        ...
        helper.assertTrue("keep_me".equals(result.getOrCreateTag().getString("custom_meta")),
    ...
    public static void fillPaletteRejectsUnknownItemsAndNoDye(GameTestHelper helper) {
        ...
        unknownItems.set(slot(3, 1, 1), new ItemStack(Items.ITEM_PALETTE.get()));
        unknownItems.set(slot(3, 0, 0), new ItemStack(net.minecraft.world.item.Items.STONE));
        TestCraftingInput unknownItemGrid = createGrid(3, 3, unknownItems);
        ...
        noDyeItems.set(slot(3, 1, 1), new ItemStack(Items.ITEM_PALETTE.get()));
        TestCraftingInput noDyeGrid = createGrid(3, 3, noDyeItems);
