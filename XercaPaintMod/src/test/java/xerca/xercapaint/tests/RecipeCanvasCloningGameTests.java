...
public class RecipeCanvasCloningGameTests {
    ...
    public static void cloningRejectsGenerationZeroOriginalCanvas(GameTestHelper helper) {
        TestCraftingInput grid = createGrid(
                2, 2,
                createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 0, "gen0"),
                new ItemStack(Items.ITEM_CANVAS.get())
        );
    ...
    public static void cloningStopsAtGenerationThree(GameTestHelper helper) {
        TestCraftingInput grid = createGrid(
                2, 2,
                createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 3, "gen3"),
                new ItemStack(Items.ITEM_CANVAS.get())
        );
    ...
    public static void cloningRejectsDifferentCanvasTypes(GameTestHelper helper) {
        TestCraftingInput grid = createGrid(
                2, 2,
                createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 1, "small"),
                new ItemStack(Items.ITEM_CANVAS_TALL.get())
        );
    ...
    public static void cloningRejectsMixedMaterials(GameTestHelper helper) {
        ...
        TestCraftingInput grid = createGrid(
                2, 2,
                createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 1, "paper"),
                new ItemStack(Items.ITEM_CANVAS_GLASS.get())
        );
    ...
    public static void cloningGlassCanvasProducesGlassCanvas(GameTestHelper helper) {
        ItemStack original = createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS_GLASS.get()), 1, "glass_clone");
        TestCraftingInput grid = createGrid(2, 2, original.copy(), new ItemStack(Items.ITEM_CANVAS_GLASS.get()));
        ...
        helper.assertTrue(result.is(Items.ITEM_CANVAS_GLASS.get()), "Expected glass clone result to stay a glass canvas");
    ...
    public static void signedCanvasesStackToSixteenBySameGeneration(GameTestHelper helper) {
        ItemStack original = createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 1, "stackable");
        ItemStack clone = RECIPE.assemble(createGrid(2, 2, original.copy(), new ItemStack(Items.ITEM_CANVAS.get())),
        ...
        ItemStack cloneAgain = RECIPE.assemble(createGrid(2, 2, original.copy(), new ItemStack(Items.ITEM_CANVAS.get())),
                helper.getLevel().registryAccess());
        ...
        ItemStack signedOriginal = createPaintedCanvas(new ItemStack(Items.ITEM_CANVAS.get()), 1, "stackable");
        ...
        ItemStack empty1 = new ItemStack(Items.ITEM_CANVAS.get());
        ItemStack empty2 = new ItemStack(Items.ITEM_CANVAS.get());
    ...
    public static void cloningConsumesFreshCanvasAndKeepsOriginalAsRemainder(GameTestHelper helper) {
        ...
        TestCraftingInput grid = createGrid(2, 2, original.copy(), new ItemStack(Items.ITEM_CANVAS.get()));
