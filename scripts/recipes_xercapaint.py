...
recipes = [
    ...
    ShapedRecipe(['cc'], {'item': 'xercapaint:item_canvas_long'}, {'c': {'item': 'xercapaint:item_canvas'}}, {'item': 'xercapaint:item_canvas'}, ""),
    ShapedRecipe(['c', 'c'], {'item': 'xercapaint:item_canvas_tall'}, {'c': {'item': 'xercapaint:item_canvas'}}, {'item': 'xercapaint:item_canvas'}, ""),
