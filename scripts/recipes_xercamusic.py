...
recipes = [
    ...
    ShapedRecipe(['  g', 'gg ', 'gg '], {'id': 'xercamusic:trumpet'}, {'g': {'item': 'minecraft:gold_nugget'}}, {'item': 'minecraft:gold_nugget'}, ""),
    ...
    ShapedRecipe(['ppp', 'srs', 'ppp'], {'id': 'xercamusic:redstone_piano'}, {'s': {'item': 'minecraft:string'}, 'r': {'item': 'minecraft:redstone'}, 'p': {'tag': 'minecraft:planks'}}, {'item': 'minecraft:redstone'}, ""),
    ShapedRecipe(['ppp', 'sgs', 'ppp'], {'id': 'xercamusic:organ'}, {'s': {'item': 'minecraft:string'}, 'g': {'item': 'minecraft:gold_nugget'}, 'p': {'tag': 'minecraft:planks'}}, {'item': 'minecraft:gold_nugget'}, ""),
