...
shaped_recipes = [
    ShapedRecipe(['sas', 'mem', 'www'], {'id': 'xercafood:glowberry_cupcake', 'count': 6}, {'a': {'item': 'minecraft:glow_berries'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:glow_berries'}, ""),
    ShapedRecipe(['www', 'mem', 'sas'], {'id': 'xercafood:ender_cupcake', 'count': 6}, {'a': {'item': 'minecraft:chorus_fruit'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:chorus_fruit'}, ""),
    ShapedRecipe(['sas', 'mem', 'www'], {'id': 'xercafood:honey_cupcake', 'count': 6}, {'a': {'item': 'minecraft:honey_bottle'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:honey_bottle'}, "cupcake"),
    ShapedRecipe(['sas', 'mem', 'www'], {'id': 'xercafood:sweet_berry_cupcake', 'count': 6}, {'a': {'item': 'minecraft:sweet_berries'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:sweet_berries'}, "cupcake"),
    ShapedRecipe(['sas', 'mem', 'www'], {'id': 'xercafood:apple_cupcake', 'count': 6}, {'a': {'item': 'minecraft:apple'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:apple'}, "cupcake"),
    ShapedRecipe(['ADA', 'BEB', 'CCC'], {'id': 'xercafood:sweet_berry_pie'}, {'A': {'item': 'minecraft:sweet_berries'}, 'B': {'item': 'minecraft:sugar'}, 'C': {'item': 'minecraft:wheat'}, 'D': {'item': 'minecraft:milk_bucket'}, 'E': {'tag': 'minecraft:eggs'}}, {'item': 'minecraft:sweet_berries'}, ""),
    ShapedRecipe(['ADA', 'BEB', 'CCC'], {'id': 'xercafood:apple_pie'}, {'A': {'item': 'minecraft:apple'}, 'B': {'item': 'minecraft:sugar'}, 'C': {'item': 'minecraft:wheat'}, 'D': {'item': 'minecraft:milk_bucket'}, 'E': {'tag': 'minecraft:eggs'}}, {'item': 'minecraft:apple'}, ""),
    ShapedRecipe(['sas', 'mem', 'www'], {'id': 'xercafood:carrot_cupcake', 'count': 6}, {'a': {'item': 'minecraft:carrot'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:carrot'}, "cupcake"),
    ...
    ShapedRecipe(['sps', 'mem', 'www'], {'id': 'xercafood:cocoa_cupcake', 'count': 6}, {'p': {'item': 'minecraft:cocoa_beans'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:cocoa_beans'}, "cupcake"),
    ...
    ShapedRecipe(['nan', 'mem', 'www'], {'id': 'xercafood:golden_cupcake'}, {'a': {'item': 'minecraft:golden_apple', 'data': 0}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}, 'n': {'item': 'minecraft:gold_nugget'}}, None, ""),
    ...
    ShapedRecipe(['sps', 'mem', 'www'], {'id': 'xercafood:melon_cupcake', 'count': 6}, {'p': {'item': 'minecraft:melon'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:melon'}, "cupcake"),
    ...
    ShapedRecipe(['sps', 'mem', 'www'], {'id': 'xercafood:pumpkin_cupcake', 'count': 6}, {'p': {'item': 'minecraft:pumpkin'}, 's': {'item': 'minecraft:sugar'}, 'e': {'tag': 'minecraft:eggs'}, 'w': {'item': 'minecraft:wheat'}, 'm': {'item': 'minecraft:milk_bucket'}}, {'item': 'minecraft:pumpkin'}, "cupcake"),
...
cooking_recipes = [
    ...
    CookingRecipe("minecraft:smelting", {'tag': 'minecraft:eggs'}, "xercafood:fried_egg", 0.2, 200, {'tag': 'minecraft:eggs'}, ""),
