...
recipes = [
    ...
    ShapedRecipe(['i', 's'], {'id': 'xercatools:copper_knife'},
                 {'s': {'item': 'minecraft:stick'}, 'i': {'item': 'minecraft:copper_ingot'}},
    ...
    ShapedRecipe(['tst', ' s ', ' s '], {'id': 'xercatools:copper_warhammer'}, {'s': {'item': 'minecraft:stick'}, 't': {'item': 'minecraft:copper_ingot'}}, {'item': 'minecraft:copper_ingot'}, "", "warhammer"),
    ...
    ShapedRecipe(['iis', ' s ', 's  '], {'id': 'xercatools:copper_scythe'}, {'i': {'item': 'minecraft:copper_ingot'}, 's': {'item': 'minecraft:stick'}}, {'item': 'minecraft:copper_ingot'}, "", "scythe"),
