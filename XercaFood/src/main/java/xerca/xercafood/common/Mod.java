...
public class Mod {
    ...
    public static InteractionResult tryCreateDoner(Player player, Level world, InteractionHand hand, BlockPos pos) {
    ...
    private void onVillagerTrades(VillagerTradesEvent event) {
        if (event.getType() == VillagerProfession.FARMER) {
            ...
            level1.add(new VillagerTrades.EmeraldForItems(Items.RICE_SEEDS, 24, 16, 2));
            level1.add(new VillagerTrades.EmeraldForItems(Items.TOMATO, 22, 16, 2));
            level1.add(new VillagerTrades.EmeraldForItems(Items.TEA_SEEDS, 18, 16, 2));
        }
    }
}
