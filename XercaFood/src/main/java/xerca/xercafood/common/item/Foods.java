...
public class Foods {
    ...
    public static FoodProperties GLOWBERRY_CUPCAKE = makeFood(6, 0.7f, false).effect(new MobEffectInstance(MobEffects.GLOWING, 300, 1), 1.0f).build();
    ...
    public static FoodProperties COLA = makeFood(3, 0.5f, false).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1000, 1), 1.0f).alwaysEat().build();
