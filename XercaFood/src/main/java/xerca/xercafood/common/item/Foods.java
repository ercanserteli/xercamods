...
public class Foods {
    ...
    public static final FoodProperties AYRAN = makeFood(4, 0.5f, false).alwaysEdible().build();
    ...
    public static final FoodProperties SAKE = makeFood(3, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 280, 1), 0.8f).build();
    public static final FoodProperties CARBONATED_WATER = makeFood(0, 0.3f, false).alwaysEdible().build();
    public static final FoodProperties SODA = makeFood(2, 0.5f, false).alwaysEdible().build();
    public static final FoodProperties COLA = makeFood(3, 0.5f, false).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1000, 1), 1.0f).alwaysEdible().build();
    ...
    public static final FoodProperties ROTTEN_BURGER = makeFood(-5, 0.7f, true).alwaysEdible().effect(new MobEffectInstance(MobEffects.POISON, 80, 0), 0.9f).build();
    ...
    public static final FoodProperties ICE_TEA = makeFood(2, 0.5f, false).alwaysEdible().build();
    public static final FoodProperties APPLE_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties CARROT_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties MELON_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties PUMPKIN_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties TOMATO_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties WHEAT_JUICE = makeFood(3, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 180, 0), 0.3f).build();
    public static final FoodProperties GLASS_OF_MILK = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static final FoodProperties GLASS_OF_WATER = makeFood(0, 0.3f, false).alwaysEdible().build();
    public static final FoodProperties TEACUP0 = makeFood(0, 0.3f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP1 = makeFood(1, 0.4f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP2 = makeFood(2, 0.4f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP3 = makeFood(3, 0.5f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP4 = makeFood(4, 0.5f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP5 = makeFood(5, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP6 = makeFood(6, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 400, 1), 1.0f).effect(new MobEffectInstance(MobEffects.CONFUSION, 300, 1), 1.0f).build();
    public static final FoodProperties GOLDEN_CUPCAKE = makeFood(16, 1.f, false).alwaysEdible().build();
