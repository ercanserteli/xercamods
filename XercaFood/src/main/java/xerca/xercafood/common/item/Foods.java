...
public class Foods {
    ...
    public static FoodProperties AYRAN = makeFood(4, 0.5f, false).alwaysEdible().build();
    ...
    public static FoodProperties SAKE = makeFood(3, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 280, 1), 0.8f).build();
    public static FoodProperties CARBONATED_WATER = makeFood(0, 0.3f, false).alwaysEdible().build();
    public static FoodProperties SODA = makeFood(2, 0.5f, false).alwaysEdible().build();
    public static FoodProperties COLA = makeFood(3, 0.5f, false).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1000, 1), 1.0f).alwaysEdible().build();
    ...
    public static FoodProperties ROTTEN_BURGER = makeFood(-5, 0.7f, true).alwaysEdible().effect(new MobEffectInstance(MobEffects.POISON, 80, 0), 0.9f).build();
    ...
    public static FoodProperties ICE_TEA = makeFood(2, 0.5f, false).alwaysEdible().build();
    public static FoodProperties APPLE_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties CARROT_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties MELON_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties PUMPKIN_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties TOMATO_JUICE = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties WHEAT_JUICE = makeFood(3, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 180, 0), 0.3f).build();
    public static FoodProperties GLASS_OF_MILK = makeFood(3, 0.6f, false).alwaysEdible().build();
    public static FoodProperties GLASS_OF_WATER = makeFood(0, 0.3f, false).alwaysEdible().build();
    public static FoodProperties TEACUP0 = makeFood(0, 0.3f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP1 = makeFood(1, 0.4f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP2 = makeFood(2, 0.4f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP3 = makeFood(3, 0.5f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP4 = makeFood(4, 0.5f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP5 = makeFood(5, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static FoodProperties TEACUP6 = makeFood(6, 0.6f, false).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 400, 1), 1.0f).effect(new MobEffectInstance(MobEffects.CONFUSION, 300, 1), 1.0f).build();
    public static FoodProperties GOLDEN_CUPCAKE = makeFood(16, 1.f, false).alwaysEdible().build();
