...
public class Foods {
    ...
    public static final FoodProperties GLOW_SQUID_INK_PAELLA = makeFood(14, 1.1f).effect(new MobEffectInstance(MobEffects.GLOWING, 1200, 1), 1.0f).build();
    ...
    public static final FoodProperties GLOWBERRY_CUPCAKE = makeFood(6, 0.7f).effect(new MobEffectInstance(MobEffects.GLOWING, 300, 1), 1.0f).build();
    ...
    public static final FoodProperties SAKE = makeFood(3, 0.6f).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 280, 1), 0.8f).build();
    ...
    public static final FoodProperties COLA = makeFood(3, 0.5f).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1000, 1), 1.0f).alwaysEdible().build();
    ...
    public static final FoodProperties ULTIMATE_BURGER = makeFood(16, 2.6f).effect(new MobEffectInstance(MobEffects.SATURATION, 1200, 0), 1.0f).build();
    public static final FoodProperties ROTTEN_BURGER = makeFood(-5, 0.7f).alwaysEdible().effect(new MobEffectInstance(MobEffects.POISON, 80, 0), 0.9f).build();
    ...
    public static final FoodProperties WHEAT_JUICE = makeFood(3, 0.6f).alwaysEdible().effect(new MobEffectInstance(MobEffects.CONFUSION, 180, 0), 0.3f).build();
    ...
    public static final FoodProperties TEACUP0 = makeFood(0, 0.3f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP1 = makeFood(1, 0.4f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP2 = makeFood(2, 0.4f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP3 = makeFood(3, 0.5f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP4 = makeFood(4, 0.5f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP5 = makeFood(5, 0.6f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f).build();
    public static final FoodProperties TEACUP6 = makeFood(6, 0.6f).alwaysEdible().effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 400, 1), 1.0f).effect(new MobEffectInstance(MobEffects.CONFUSION, 300, 1), 1.0f).build();
