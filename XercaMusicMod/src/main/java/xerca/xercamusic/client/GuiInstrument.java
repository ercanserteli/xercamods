...
public class GuiInstrument extends Screen {
    ...
    public void render(@NotNull PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        blit(matrixStack, octaveHighlightX, octaveHighlightY, 0, 0, guiOctaveHighlightY, guiOctaveHighlightWidth, guiOctaveHighlightHeight, 512, 512);
        ...
        for(int i=0; i<8; i++){
            if(i < instrument.getMinOctave() || i > instrument.getMaxOctave()){
                ...
                blit(matrixStack, x, y, 0, guiOctaveBlockX, guiOctaveBlockY, guiOctaveBlockWidth, guiOctaveBlockHeight, 512, 512);
            }
        }
