...
public class SendNotesPartToServerPacket {
    ...
    public static void encode(SendNotesPartToServerPacket pkt, PacketBuffer buf) {
    ...
    public static SendNotesPartToServerPacket decode(PacketBuffer buf) {
        SendNotesPartToServerPacket result = new SendNotesPartToServerPacket();
        try {
            result.uuid = buf.readUniqueId();
