...
public class SoundEvents {
    ...
    public static void registerSoundEvents() {
        ...
        metronomeSet = createSoundEvent("metronome_set");
        openScroll = createSoundEvent("open_scroll");
        closeScroll = createSoundEvent("close_scroll");
        ...
        addRange(harpMcs, NAME_HARP_MC, 27, 111, 6);
        ...
        addFixed(tubularBells, NAME_TUBULAR_BELL,
        ...
        addFixed(redstoneGuitars, NAME_REDSTONE_GUITAR,
                27, 33, 39, 45, 51, 57, 63, 69, 75, 81, 87);

        addFixed(frenchHorns, NAME_FRENCH_HORN,
                27, 33, 39, 45, 51, 57, 63, 69, 75, 81, 87);
        ...
        ((IItemInstrument) Items.TUBULAR_BELL).setSounds(tubularBells);
