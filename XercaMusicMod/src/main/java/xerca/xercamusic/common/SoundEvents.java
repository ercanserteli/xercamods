...
public class SoundEvents {
    ...
    // Instrument SoAbstractMap.SimpleImmutableEntry<Integer, SoundEvent>on
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> cymbals;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> drum_kits;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> guitars;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> lyres;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> drums;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> flutes;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> banjos;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> saxophones;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> gods;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> harp_mcs;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> sansulas;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> tubular_bells;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> violins;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> xylophones;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> cellos;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> pianos;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> oboes;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> redstone_guitars;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> french_horns;
    public static ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> bass_guitars;
    ...
    private static void addSound(ArrayList<AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>> array, String insName, int note, final RegistryEvent.Register<SoundEvent> event){
        array.add(new AbstractMap.SimpleImmutableEntry<Integer, SoundEvent>(note, createSoundEvent(insName + note, event)));
    }
