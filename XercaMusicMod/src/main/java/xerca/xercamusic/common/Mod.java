...
public class Mod {
    ...
    private void onRegister(RegisterEvent event) {
        ...
        event.register(Registries.TRIGGER_TYPE, helper -> helper.register(Identifier.withDefaultNamespace("become_musician"), Triggers.BECOME_MUSICIAN));
    }
    ...
    private void onServerStarted(ServerStartedEvent event) {
        MusicManager.migrateLegacyData(event.getServer());
    }
